...
//As f is a polynomial in x[9],..,x[13], it is by construction in the image of the coord ring of X_0(105)/w_5
//We check that f is not a square in the coordinate ring of X_0(105)/w_5.
CRX<[xx]>:=CoordinateRing(AmbientSpace(X));
ff:=Evaluate(f,[0,0,0,0,0,0,0,0] cat xx);
assert not IsSquare(ff); 
//This proves that X_0(105) --> X_0(105)/w_5 is the degree 2 cover defined by g^2=f. 

//We construct this cover.
