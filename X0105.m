...
//This shows that CQ is generated by ptsX[2]+ptsX[3]-2*ptsX[1] and ptsX[2]-ptsX[1], with orders 8 and 4 respectively.
ptsX:=PointSearch(X35,500);
MWgp:=[a*(Divisor(ptsX[2])+Divisor(ptsX[3])-2*Divisor(ptsX[1]))+b*(Divisor(ptsX[3])-Divisor(ptsX[1])) : a in [0..4], b in [0..7]]; 
